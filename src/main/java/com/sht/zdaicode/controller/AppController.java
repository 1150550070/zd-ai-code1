...
import com.sht.zdaicode.common.DeleteRequest;
...
import com.sht.zdaicode.model.dto.app.*;
...
import com.sht.zdaicode.ratelimiter.annotation.RateLimit;
import com.sht.zdaicode.ratelimiter.enums.RateLimitType;
import com.sht.zdaicode.service.CacheService;
import com.sht.zdaicode.service.ChatHistoryService;
import com.sht.zdaicode.service.ProjectDownloadService;
...
public class AppController {
     ...
     * @param appId   应用 id
     * @param message 用户消息
     * @param agent   是否使用 Agent 模式（可选参数，默认为 false）
     * @param request 请求
     * @return 代码
     */
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.sht.zdaicode.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    public BaseResponse<Boolean> updateAppByAdmin(@RequestBody AppAdminUpdateRequest appAdminUpdateRequest) {
        ...
        // 检查是否更新了优先级（精选应用相关）
        boolean priorityChanged = appAdminUpdateRequest.getPriority() != null && 
                !appAdminUpdateRequest.getPriority().equals(oldApp.getPriority());
        ...
        if (priorityChanged) {
            try {
                ...
                new Thread(() -> {
                    try {
                        Thread.sleep(100); // 稍等一下确保数据库更新完成
